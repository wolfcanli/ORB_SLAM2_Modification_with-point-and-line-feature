...
public:
     ...
     *          bRobust  是否使用核函数
     */
    void static BundleAdjustment(const std::vector<KeyFrame*> &vpKFs, const std::vector<MapPoint*> &vpMPs,
     ...
     *          bRobust  是否使用核函数
     */
    void static BundleAdjustmentWithLines(const std::vector<KeyFrame*> &vpKFs,

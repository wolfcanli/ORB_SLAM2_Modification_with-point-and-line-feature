//
// Created by jiajieshi on 22-7-18.
//
...
int main()
{
    ...
    std::string setting_dir = "./dataset.yaml";
    ...
    fSettings["SettingDir"] >> tum_yaml_dir;
    std::string orb_voc_dir = "../../Vocabulary/ORBvoc.txt";
    ...
    ORB_SLAM2::System SLAM(orb_voc_dir, tum_yaml_dir, ORB_SLAM2::System::RGBD, true);
    ...
    std::cout << "DatasetDir: " << dataset_dir << std::endl;
    std::cout << "SettingDir: " << tum_yaml_dir << std::endl;
    std::cout << "VocabularDir: " << orb_voc_dir << std::endl;
    std::cout << "AssociateDir: " << associate_txt_dir << std::endl;
    ...
    for(int ni = 0; ni < nImages; ni++) {
        ...
        std::cout << "Tracking one frame cost " << ttrack * 1000 << " ms" << std::endl;
